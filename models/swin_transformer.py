...
#     pad_h = (window_size - H % window_size) % window_size
#     pad_w = (window_size - W % window_size) % window_size
#     B = windows.shape[0] // ((H + pad_h) * (W + pad_w) // window_size // window_size)
#     x = windows.view(B, (H + pad_h) // window_size, (W + pad_w) // window_size, window_size, window_size, -1)
#     x = x.permute(0, 5, 1, 3, 2, 4).contiguous().view(B, -1, H + pad_h, W + pad_w)
#     x = x[:, :, :H, :W]
#     return x
